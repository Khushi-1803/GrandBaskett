...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-2 md:px-16 lg:px-24 xl:px-32 h-20 border-b border-gray-300 bg-white relative transition-all">
                ...
                (
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
                            ...
                            <li onClick={logout} className='p-1.5 pl-3 hover:bg-orimary/10 cursor-pointer'>Logout</li>
                        </ul>
                    </div>
                )}
            </div>
