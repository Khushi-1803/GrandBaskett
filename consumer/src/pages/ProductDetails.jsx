...
const ProductDetails = () => {
    ...
    return product && (
        <div className="t-12">
            ...
            <button onClick={()=>{navigate("/products"); scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transiyion">See more</button>
        </div>
    );
};
