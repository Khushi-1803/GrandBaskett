...
//                 <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-800">
...
//                                 <tr key={product._id} className="border-t hover:bg-gray-50 transition border-gray-800">
        ...
        <table className="md:table-auto table-fixed w-full min-w-[600px]">
          ...
          <tbody className="text-sm text-gray-500">
            {products.map((product) => (
              <tr
                key={product._id}
                className="border-t hover:bg-gray-50 transition border-gray-800"
              >
                <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 truncate">
                  <div className="border border-gray-500 rounded overflow-hidden">
                    <img
